...
public class CircularSeekBar extends View {
	...
	// Default values
	private static final float DEFAULT_CIRCLE_X_RADIUS = 10f;
	...
	private static final int DEFAULT_MAX = 720;
	private static final int DEFAULT_PROGRESS = 0;
	private static final int DEFAULT_CIRCLE_COLOR = Color.TRANSPARENT;
	private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.parseColor("#B8A171");
	//private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.DKGRAY;
	private static final int DEFAULT_POINTER_COLOR = Color.parseColor("#B8A171");
	private static final int DEFAULT_POINTER_HALO_COLOR = Color.WHITE;
	...
	protected void onDraw(Canvas canvas) {
		...
		//Bitmap icon = BitmapFactory.decodeResource(getContext().getResources(),R.drawable.timer_button);
...
/*		mProgress = progress;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mCircleHeight = (float)height / 2.4f - mCircleStrokeWidth - mPointerRadius - (mPointerHaloBorderWidth * 1.5f);
		mCircleWidth = (float)width / 2.4f - mCircleStrokeWidth - mPointerRadius - (mPointerHaloBorderWidth * 0.5f);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			if (mUserIsMovingPointer) {
				...
				if (lockAtStart && !mIsMovingCW && (ccwDistanceFromStart > 0)) 
				{
					if(ReminderActivity.ampm == 1)
					{
						ReminderActivity.ampm = 0;
					}else
					{
						ReminderActivity.ampm = 1;
					}
					lockAtStart = false;
				}
